...
<p style="color: red; font-weight: bold; font-size: 1.1em;">⚠️ WARNING: The live AWS deployment has been taken down to manage cloud costs and will be deployed elsewhere shortly.</p>
...
Link : [http://wealth-smith-frontend-web.s3-website-us-east-1.amazonaws.com/] ----- Removed (aws credits got over!)
